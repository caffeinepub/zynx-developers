...
import type { Inquiry as _Inquiry, InquiryId as _InquiryId, Plan as _Plan, Time as _Time, UserProfile as _UserProfile, UserRole as _UserRole } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async submitInquiry(arg0: Inquiry): Promise<{
        id: InquiryId;
        submittedAt: Time;
    }> {
        if (this.processError) {
            try {
                const result = await this.actor.submitInquiry(to_candid_Inquiry_n11(this._uploadFile, this._downloadFile, arg0));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_variant_n7(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return "highGraphic" in value ? Plan.highGraphic : "basic" in value ? Plan.basic : "luxury" in value ? Plan.luxury : value;
}
...
function to_candid_Inquiry_n11(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Inquiry): _Inquiry {
    return to_candid_record_n12(_uploadFile, _downloadFile, value);
}
function to_candid_Plan_n13(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Plan): _Plan {
...
function to_candid_record_n12(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        websiteDescription: value.websiteDescription,
        name: value.name,
        plan: to_candid_Plan_n13(_uploadFile, _downloadFile, value.plan),
        businessType: value.businessType,
        submittedAt: value.submittedAt,
        email: value.email,
        phone: value.phone,
...
function to_candid_variant_n14(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Plan): {
    highGraphic: null;
} | {
    basic: null;
} | {
